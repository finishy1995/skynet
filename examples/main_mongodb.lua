...
skynet.start(function()
	...
	local console = skynet.newservice(
		"testmongodb", "test-shard-00-02.phc4r.mongodb.net", 27017, "mydb", "mytbl", "test", "test2024SSS", "/Users/davidwang//Downloads/atlas.crt", "/Users/davidwang//Downloads/atlas.key"
